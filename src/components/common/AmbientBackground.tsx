...
const AmbientBackground = () => {
  ...
  return (
    <div className="pointer-events-none fixed inset-0 z-0 overflow-hidden">
      ...
      <motion.div
        className="absolute left-0 top-0 h-[2px] w-full bg-[linear-gradient(90deg,rgba(59,130,246,0),rgba(59,130,246,0.9),rgba(239,68,68,0.8),rgba(59,130,246,0))]"
        animate={reduceMotion ? undefined : { x: ['-18%', '22%', '-18%'], opacity: [0.25, 0.55, 0.25] }}
